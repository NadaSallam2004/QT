...
If you want to build any of the tasks here yourself:

1. Install **Qt 6.8+** via the [Qt Online Installer](https://www.qt.io/download-qt-installer), including the `Quick` and `Network` modules.
2. Open the project folder in **Qt Creator**, or build from the command line:
   ```bash
...
- [Qt for Beginners tutorials](https://doc.qt.io/qt-6/gettingstarted.html)
